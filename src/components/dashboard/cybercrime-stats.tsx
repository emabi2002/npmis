...
import { CYBERCRIME_URL } from "@/lib/urls" // <- single source of truth
...
export function CybercrimeStatsSection() {
  ...
  const loadStats = async () => {
    try {
      setLoading(true)
      setError(null)
      const statsData = await cybercrimeApi.getStatistics()
      setStats(statsData)
    } catch (err) {
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription>
              ...
              <div className="mt-2 flex gap-2">
                ...
                {/* Always open the official Cybercrime app */}
                <a href={CYBERCRIME_URL} target="_blank" rel="noopener noreferrer">
                  <Button size="sm">
  ...
  const monthlyChange =
    stats.monthlyTrends.currentMonth.cases - stats.monthlyTrends.lastMonth.cases

  const solveRateChange =
    (stats.monthlyTrends.currentMonth.solved / Math.max(stats.monthlyTrends.currentMonth.cases, 1)) -
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* FIXED: hard-locked to Cybercrime URL */}
              <a href={CYBERCRIME_URL} target="_blank" rel="noopener noreferrer">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-yellow-600">{stats.urgentCases} high priority</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-green-600 flex items-center gap-1">
                  {solveRateChange >= 0 ? <TrendingUp className="h-3 w-3" /> : <TrendingDown className="h-3 w-3" />}
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      {case_.assignedOfficer && (
                        <p className="text-xs text-gray-500">Assigned to {case_.assignedOfficer}</p>
                      )}
                      {case_.estimatedLoss && (
