        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-blue-600">12 solved this week</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-green-600">92% deployment rate</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-green-600">↓ 2min faster</p>
            </CardContent>
          </Card>
        </div>
              ...
              <div className="space-y-4">
                <div className="p-3 bg-red-50 rounded border-red-200 border">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-sm">
                    <div><span className="text-gray-600">Incidents:</span><div className="font-medium">15</div></div>
                    <div><span className="text-gray-600">Units:</span><div className="font-medium">23</div></div>
                    <div><span className="text-gray-600">Response:</span><div className="font-medium">7.2m</div></div>
                  </div>
                </div>
                ...
                <div className="p-3 bg-yellow-50 rounded border-yellow-200 border">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-sm">
                    <div><span className="text-gray-600">Incidents:</span><div className="font-medium">5</div></div>
                    <div><span className="text-gray-600">Units:</span><div className="font-medium">12</div></div>
                    <div><span className="text-gray-600">Response:</span><div className="font-medium">9.8m</div></div>
                  </div>
                </div>
                ...
                <div className="p-3 bg-green-50 rounded border-green-200 border">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-sm">
                    <div><span className="text-gray-600">Incidents:</span><div className="font-medium">2</div></div>
                    <div><span className="text-gray-600">Units:</span><div className="font-medium">8</div></div>
                    <div><span className="text-gray-600">Response:</span><div className="font-medium">12.1m</div></div>
                  </div>
                </div>
              </div>
            </CardContent>
